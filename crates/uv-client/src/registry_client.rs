...
impl SimpleDetailMetadata {
    ...
    fn from_pypi_files(
        ...
        // Keep file ordering deterministic without sorting filenames across unrelated versions.
        // Sorting the complete Simple API response is comparatively expensive for projects with
        // many releases, while consumers only observe the per-version wheel and source-dist lists.
